...
| M8  | Hardening, tests, docs                                             | 🟡     | Tests written for blocks + linking. Lighthouse + flag flip pending production rollout.   |
...
| ------------------- | ------------- | -------------- | ------------------------ |
| `FF_FOUNDER_BLOCKS` | ON            | OFF            | `VITE_FF_FOUNDER_BLOCKS` |
| `FF_NOTE_LINKS`     | ON            | OFF            | `VITE_FF_NOTE_LINKS`     |
| `FF_TEMPLATES`      | ON            | OFF            | `VITE_FF_TEMPLATES`      |
| `FF_INLINE_AI`      | ON            | OFF            | `VITE_FF_INLINE_AI`      |
| `FF_DAILY_BRIEFING` | ON            | OFF            | `VITE_FF_DAILY_BRIEFING` |
| `FF_NOTE_AGING`     | ON            | OFF            | `VITE_FF_NOTE_AGING`     |
| `FF_MOOD_ROUTING`   | ON            | OFF            | `VITE_FF_MOOD_ROUTING`   |
...
- `npm run lint` — passes
- `npm run test` — passes (component tests for new blocks + link state machine)
