...
const StatsSection = lazy(() =>
  import("@/components/explore/StatsSection").then((m) => ({ default: m.StatsSection }))
);
const FeaturesGridSection = lazy(() =>
  import("@/components/explore/FeaturesGridSection").then((m) => ({ default: m.FeaturesGridSection }))
);
